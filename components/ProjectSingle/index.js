                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="wpo-solutions-item">
                                        ...
                                        <div className="wpo-solutions-text">
                                            <h2><Link onClick={ClickHandler} to="/service-single">Business Planning</Link></h2>
                                ...
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="wpo-solutions-item">
                                        ...
                                        <div className="wpo-solutions-text">
                                            <h2><Link onClick={ClickHandler} to="/service-single">Market Analysis</Link></h2>
                                            <p>The lower-numbered purposes are better understood and practiced </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6 col-12">
                                    <div className="wpo-solutions-item">
                                        ...
                                        <div className="wpo-solutions-text">
                                            <h2><Link onClick={ClickHandler} to="/service-single">Investment Strategy</Link></h2>
                                            <p>The lower-numbered purposes are better understood and practiced </p>
                                        </div>
                                    </div>
                                </div>
